...
# -*- coding: utf-8 -*-
"""
Created on Tue May 29 17:36:15 2018

@author: rosavandenende
"""

#In dit bestand: ik hoef alleen maar als output de waarde van sigma en het aantal triggers per twee minuten. That's it. Alle overige lijsten moeten weer leeg. 
...
#    teller_list = []
    ...
    for i in file_list[a:b]:
        ...
        for startpoint in range(0,c):                                                  #hoeveel stukjes van 120 sec wil je
            for j in range(startpoint,int(startpoint+samples_per_sigma)):                       #deze is dus max 2 min                                
                waveFile.setpos(j)
...
#                teller += 1                                                                            
                if element >= (5*sigma):
                    triggered += 1
            triggered_list.append(triggered)                  #Let op!! Hier is triggered_list de lijst met de HOEVEELHEDEN getriggerd, dus niet de getriggerede elementen
