...
#in this document: plotting the noise level and the number of triggered signals over time. 
...
#       date_list.append(i)
        ...
        for startpoint in range(0,c):                                                  #hoeveel stukjes van 120 sec wil je
            ...
            triggered = 0
    np.savetxt("%i %i %i 5sigma and triggered" %(a,b,c),[sigma_list,triggered_list])
